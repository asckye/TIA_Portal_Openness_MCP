...
runtime\v21\TiaMcpServer.exe --tia-major-version 21 --tia-portal-location "C:\Program Files\Siemens\Automation\Portal V21" --transport http --http-prefix "http://192.0.2.10:8765/" --http-api-key "替换为你的旧密钥" --logging 1
