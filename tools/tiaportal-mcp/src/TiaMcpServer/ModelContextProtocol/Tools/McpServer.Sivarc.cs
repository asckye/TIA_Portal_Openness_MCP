...
namespace TiaMcpServer.ModelContextProtocol
{
    public static partial class McpServer
    {
        ...
        public static ResponseMessage ManageSivarcTableRule(
            ...
            [Description("referencesJson: JSON object of library references for the rule (see the tool description).")] string referencesJson="{}",
            [Description("deviceSelectionJson: JSON object selecting PLC / HMI devices for the rule.")] string deviceSelectionJson="{}",
            [Description("deviceNamesJson: JSON array of device names.")] string deviceNamesJson="[]",
            string libraryName="",
