...
namespace TiaMcpServer.ModelContextProtocol
{
    ...
    public static partial class McpServer
    {
        ...
        public static ResponseMessage ManageTestSuiteCase(
            ...
            [Description("scopeJson: JSON object describing the test scope (see the tool description).")] string scopeJson="[]",
            [Description("targetName: exact name of the target object.")] string targetName="",
            string masterCopyPath="",
            string libraryName="",
            bool dryRun=true)
            => Portal.ManageTestSuiteCase(category,name,action,kind,newName,softwarePath,instanceName,executionMode,opcUaServerAddress,serverInterfaceType,interfaceFolderPath,updateOptions,scopeJson,targetName,masterCopyPath,libraryName,dryRun);
    }
}
