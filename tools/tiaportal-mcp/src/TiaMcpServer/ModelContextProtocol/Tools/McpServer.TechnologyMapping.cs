...
namespace TiaMcpServer.ModelContextProtocol
{
    public static partial class McpServer
    {
        ...
        public static ResponseMessage ReadTechnologyObjectTree(string softwarePath, string groupPath="", bool includeParameters=false, bool includeMotionView=false, int maxDepth=4)
