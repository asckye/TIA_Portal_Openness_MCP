...
namespace TiaMcpServer.ModelContextProtocol
{
    public static partial class McpServer
    {
        ...
        public static ResponseMessage ReadUnifiedPlantObject(string plantPath="", string objectPathJson="[]", int offset=0, int limit=100)
        ...
        public static ResponseMessage ManageUnifiedPlantNode(string plantPath, string action, string plantObjectType="", string propertiesJson="{}", bool dryRun=true)
        ...
        public static ResponseMessage UpdateUnifiedPlantObject(string plantPath, string objectPathJson, string propertiesJson, bool dryRun=true)
        ...
        public static ResponseMessage UpdateUnifiedMultilingualProperty(string softwarePath, string objectPathJson, string property, string culture, string rawText, bool dryRun=true)
        ...
        public static ResponseMessage GetUnifiedCrossReferences(string softwarePath, string objectPathJson, string filter="AllObjects")
        ...
        public static ResponseMessage ManageUnifiedLoggingTag(string softwarePath, string tagPathJson, string action="read", string name="", string propertiesJson="{}", bool dryRun=true)
        ...
        public static ResponseMessage SetUnifiedLogDuration(string softwarePath, string durationPathJson, string kind, uint days, uint hours, uint minutes, uint seconds, uint hundredNanoseconds, bool dryRun=true)
        ...
        public static ResponseMessage ManageUnifiedOpcUaAlarmType(string softwarePath, string name, string nodeId, string connection, string action="create", bool dryRun=true)
