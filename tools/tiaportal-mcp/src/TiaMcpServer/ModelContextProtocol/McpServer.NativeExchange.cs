...
namespace TiaMcpServer.ModelContextProtocol
{
    public static partial class McpServer
    {
        ...
        [McpServerTool(Name="GeneratePlcSourceFromBlocks"), Description("[L2][PLC][FILE] Generate native source from 1..500 exact block paths (JSON array). New absolute output file only; SHA-256 returned. Unsupported block languages rejected; default preview.")]
