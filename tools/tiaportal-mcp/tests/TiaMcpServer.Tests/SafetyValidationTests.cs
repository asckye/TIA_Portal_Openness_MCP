...
namespace TiaMcpServer.Tests
{
    ...
    internal static class SafetyValidationTests
    {
        ...
        internal static void Run(Action<bool, string> check)
        {
            ...
            check(C("update", 1, props: "{\"comment\":\"c\",\"response\":\"NotRelevant\",\"signalUsage\":\"Response\"}", dryRun: false).Writes && C("delete", 2, dryRun: false).Writes, "conditions: update / delete by index");
