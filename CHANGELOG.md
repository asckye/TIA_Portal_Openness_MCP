...
- **验证**：离线 1550 项（新增 44 项）；形状检查 V20 1291 / V21 1388（新增 133 / 133 项）；两版 EXE 回归见 `manifest/release-build.json`。**真实工程验收待部署后重跑**（组合刷新修复、通道 accessMode、工程库读取、`ManageGlobalLibrary infos`）。
