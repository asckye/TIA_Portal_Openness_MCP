# 路线图与待办（2026-09-17 审计，2.7.43 更新）
...
状态（2.7.43）：本表各项已在 2.7.18–2.7.36 间落地（对应版本见 §5 各段与 CHANGELOG），本表保留为当时的优先级依据；未做的只剩 §2.2 的无 API 项与 §2.0 阶段 6 的选件包。
